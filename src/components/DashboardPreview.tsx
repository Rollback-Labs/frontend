        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Our user-friendly dashboard makes it easy to set up and manage
              your rollback protection. Monitor your wallets, configure
              fallbacks, and enjoy peace of mind with just a few clicks.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Configure your rollback parameters in minutes with our
                    guided process
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    View current status and remaining time before rollback
                    activation
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Receive alerts when your wallets approach inactivity
                    thresholds
                  </p>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-r from-rollback-primary/10 to-rollback-secondary/10 p-4 rounded-lg border border-rollback-primary/20 mb-6">
                  ...
                  <div className="relative">
                    ...
                    {[
                      {
                        time: "Today",
                        event: "Wallet 0x71C...9E3F refreshed activity",
                        icon: <Wallet />,
                      },
                      {
                        time: "2 days ago",
                        event: "Updated fallback parameters",
                        icon: <Settings />,
                      },
                      {
                        time: "5 days ago",
                        event: "Added new secondary fallback",
                        icon: <Plus />,
                      },
                    ].map((item, index) => (
                      <motion.div
